...
- Налаштовано середовище розробки **VS Code** з необхідними розширеннями для Python
- Створено репозиторій на **GitHub** та підключено його до локального середовища
- Написано та запущено першу програму на Python двома способами: через кнопку **Run** та через **термінал**
- Створено **Jupyter Notebook** та виконано код в комірках — [note.ipynb](note.ipynb)
- Освоєно базовий синтаксис Python: `print()`, `input()`, умовні конструкції `if/else`, перетворення типів `int()`
- Навчились оформлювати звіти у форматі **Markdown**

Мета роботи досягнута: середовище налаштовано, перші програми написано та успішно запущено.
